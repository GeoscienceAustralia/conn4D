...
public interface VelocityReader {
	...
	/**
	 * Retrieves the array object representing a NODATA value from the
	 * velocity files.
	 * 
	...
	public abstract double[] getVelocities(long time, double z, double lon, double lat);
	
	/**
	 * Identifies whether previously queried velocity values contained a NODATA value.
	 * 
	 * @return boolean indicating whether NODATA was in the vicinity of queried velocity values
	 */
